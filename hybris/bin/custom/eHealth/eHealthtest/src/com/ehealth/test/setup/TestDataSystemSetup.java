 ...
 *  
 */
package com.ehealth.test.setup;
...
import com.ehealth.test.constants.EHealthTestConstants;
import com.ehealth.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = EHealthTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/eHealthtest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/eHealthtest/import/reviews.impex");
			...
			importImpexFile(context, "/eHealthtest/import/cstickets.impex");
		}
	}
}
