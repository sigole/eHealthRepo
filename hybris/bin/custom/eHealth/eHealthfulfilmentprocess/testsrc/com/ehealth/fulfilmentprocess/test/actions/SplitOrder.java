 ...
 *  
 */
package com.ehealth.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(EHealthFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(EHealthFulfilmentProcessConstants.PARENT_PROCESS);
