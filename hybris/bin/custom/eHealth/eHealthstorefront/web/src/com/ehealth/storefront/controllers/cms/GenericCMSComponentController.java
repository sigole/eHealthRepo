 ...
 *
 */
package com.ehealth.storefront.controllers.cms;
...
public class GenericCMSComponentController extends AbstractController
{
	...
	@Value("#{configurationService.configuration.getProperty('eHealthstorefront.generic.cms.component.controller.authorized.group')}")
