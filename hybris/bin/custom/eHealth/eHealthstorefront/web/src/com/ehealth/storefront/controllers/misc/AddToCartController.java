...
import com.ehealth.storefront.addon.pages.EHealthAddToCartForm;
...
public class AddToCartController extends AbstractController
{
	...
	public String addToCart(@RequestParam("productCodePost") final String code, final Model model,
			@Valid final EHealthAddToCartForm form, final BindingResult bindingErrors)
	{
		//	**********************************add to cart controller.java*************************************
