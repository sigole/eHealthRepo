...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/eHealthstorefront/electronics/en",
						"https://electronics.local:9002/eHealthstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/eHealthstorefront/electronics/en",
						"https://electronics.local:9002/eHealthstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/eHealthstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/eHealthstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/eHealthstorefront/electronics/en",
						"https://electronics.local:9002/eHealthstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/eHealthstorefront",
						"https://electronics.local:9002/eHealthstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/eHealthstorefront",
						"https://electronics.local:9002/eHealthstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/eHealthstorefront/electronics/en",
						"https://electronics.local:9002/eHealthstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
