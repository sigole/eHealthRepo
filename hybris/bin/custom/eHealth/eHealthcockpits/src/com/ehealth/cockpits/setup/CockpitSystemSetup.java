 ...
 *  
 */
package com.ehealth.cockpits.setup;
...
import com.ehealth.cockpits.constants.EHealthCockpitsConstants;
 ...
 */
@SystemSetup(extension = EHealthCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(EHealthCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(EHealthCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						EHealthCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/eHealthcockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
