...
/**
 * This is the extension manager of the EHealthcommerceservices extension.
 */
public class EHealthcommerceservicesManager extends GeneratedEHealthcommerceservicesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(EHealthcommerceservicesManager.class.getName());
	 ...
	 */
	public static EHealthcommerceservicesManager getInstance()
	{
		return (EHealthcommerceservicesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				EHealthcommerceservicesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public EHealthcommerceservicesManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of EHealthcommerceservicesManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of EHealthcommerceservicesManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of EHealthcommerceservicesManager called, current tenant: " + getTenant().getTenantID());
		}
	}
